...
data_a = pd.read_fwf('C:\\Users\\M68153\\OneDrive - Microchip Technology Inc\\Desktop\\Coding\\evo_log_data\\DA5_Copy\\4BLOCKTEST\\01_04.ram', skiprows=3, skipfooter=89, colspecs=[(0,23), (23,37), (37,-1)], names=['Category', 'System 1', 'System 2'])
#print(f'OEE113 Data{data_a}')

data_b = pd.read_fwf('C:\\Users\\M68153\\OneDrive - Microchip Technology Inc\\Desktop\\Coding\\evo_log_data\\DA5_Copy\\4BLOCKTEST\\01_04.ram', skiprows=31, skipfooter=61, colspecs=[(0,23), (23,37), (37,-1)], names=['Category', 'System 1', 'System 2'])
#print(f'OEE113 Data{data_b}')

data_c = pd.read_fwf('C:\\Users\\M68153\\OneDrive - Microchip Technology Inc\\Desktop\\Coding\\evo_log_data\\DA5_Copy\\4BLOCKTEST\\01_04.ram', skiprows=59, skipfooter=33, colspecs=[(0,23), (23,37), (37,-1)], names=['Category', 'System 1', 'System 2'])
# print(f'OEE113 Data{data_c}')
# print(f'OEE113 Data{data_c.shape}')

data_d = pd.read_fwf('C:\\Users\\M68153\\OneDrive - Microchip Technology Inc\\Desktop\\Coding\\evo_log_data\\DA5_Copy\\4BLOCKTEST\\01_04.ram', skiprows=87, skipfooter=6, colspecs=[(0,23), (23,37), (37,-1)], names=['Category', 'System 1', 'System 2'])
